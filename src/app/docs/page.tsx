    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="mx-auto max-w-5xl px-6 py-12 md:py-16">
        <div className="flex flex-col gap-3">
          <p className="text-sm uppercase tracking-wide text-muted-foreground">Path Tracker</p>
          <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Observe your distributed system in minutes
          </h1>
          <p className="max-w-3xl text-lg text-muted-foreground">
            Track REST and LLM requests across services, visualize request paths, and monitor costs,
            latency, and errors—all in one lightweight dashboard.
          </p>
